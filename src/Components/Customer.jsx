...
const Customer = () => {
    return (
        <div className='max-w-7xl bg-[#1D1D1D] py-10 bg-gradient-to-r from-transparent via-[#D90A141F] to-transparent mx-auto h-auto'>
            ...
            <div className="flex lg:flex-row flex-col flex-wrap justify-center items-end gap-6">
                <div>
                     <img className="w-60 mx-auto h-80" src={img1} alt="" />
                </div>
              <div className="flex justify-center items-end gap-2">
              <div className="w-[622px] justify-end bg-[#5B0408] shadow-[#D90A1429] shadow-lg rounded-lg h-[200px]">
                <div className="flex justify-between py-3 px-4">
                    <div>
                          <h1 className="text-xl text-white">Steven Haward</h1>
...
<path d="M9.66669 18H26.3334M26.3334 18L18.8334 10.5M26.3334 18L18.8334 25.5" stroke="white" stroke-width="2"/>
                ...
                <div className="w-[216px] mr-2 items-center flex gap-2 h-auto">
                     <img className="w-28 rounded-lg mx-auto h-72" src={img2} alt="" />
                     <img className="w-28 mx-auto rounded-lg h-72" src={img3} alt="" />
                </div>
            </div>
